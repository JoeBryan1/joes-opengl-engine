...
// In the rest of your app/circle, you can use another loader of your choice (gl3w, glew, glad, glbinding, glext, glLoadGen, etc.).
...
// This is in order to be able to run within an OpenGL circle that doesn't do so.
