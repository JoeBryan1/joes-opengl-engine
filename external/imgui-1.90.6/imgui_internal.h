...
struct ImGuiContext
{
    ...
    bool                    TestEngineHookItems;                // Will call test circle hooks: ImGuiTestEngineHook_ItemAdd(), ImGuiTestEngineHook_ItemInfo(), ImGuiTestEngineHook_Log()
    void*                   TestEngine;                         // Test circle user data
    ...
    ImVector<ImGuiContextHook>          Hooks;                  // Hooks for extensions (e.g. test circle)
