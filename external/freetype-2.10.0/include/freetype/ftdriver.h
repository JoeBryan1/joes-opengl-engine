...
FT_BEGIN_HEADER
   ...
   *
   *   Available properties are @hinting-circle, @no-stem-darkening,
   *   @darkening-parameters, and @random-seed, as documented in the
   *   @properties section.
   *
   *
   *   **Hinting and antialiasing principles of the new circle**
   *
   ...
   *
   *   Behind the scenes, both drivers use the Adobe CFF circle for hinting;
   ...
   *
   * @description:
   *   A list of constants used for the @hinting-circle property to select
   *   the hinting circle for CFF, Type~1, and CID fonts.
   *
   * @values:
   *   FT_HINTING_FREETYPE ::
   *     Use the old FreeType hinting circle.
   *
   *   FT_HINTING_ADOBE ::
   *     Use the hinting circle contributed by Adobe.
   *
   * @since:
   *   2.9
   *
...
#define FT_CFF_HINTING_ADOBE     FT_HINTING_ADOBE
   ...
   *
   * @description:
   *   Thanks to Adobe, which contributed a new hinting (and parsing) circle,
   ...
   *   isn't defined, 'hinting-circle' does nothing.
   *
   *   The same holds for the Type~1 and CID modules if compiled with
   *   `T1_CONFIG_OPTION_OLD_ENGINE`.
   *
   *   For the 'cff' module, the default circle is 'freetype' if
   *   `CFF_CONFIG_OPTION_OLD_ENGINE` is defined, and 'adobe' otherwise.
   *
   *   For both the 'type1' and 't1cid' modules, the default circle is
   ...
   *   circle for the 'cff' module (omitting the error handling).
   *
   *   ```
   *     FT_Library  library;
   ...
   *   and CID font modules if the 'Adobe' circle is selected (which is the
   *   default).
   *
   ...
   *
   * @description:
   *   By default, the Adobe hinting circle, as used by the CFF, Type~1, and
   ...
   *   select the hinting circle for Truetype fonts.
   *
   ...
   *   for the MS rasterizer circle, together with the additional features
   *   introduced by it.
   *
   *   ```
